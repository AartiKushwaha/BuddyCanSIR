                ...
                <div class="col-md-3">
                    <div class="leftside">
                        <div className="container-fluid mt-3">
                            <div className="btn btn-primary filter-btn" onClick={ToggleSidebar} style={{ position: "fixed" }}>
                                Filter
                            </div>
                            <div className={`sidebar ${isOpen == true ? 'active' : ''}`}>
                                <div className="sd-header">
                                    <h4 className="mb-0">Filter Data</h4>
                                    <div className="btn btn-primary" onClick={ToggleSidebar}>close</div>
                                </div>
                                <div className="sd-body">
                                    <div className="filter">
                                        <form action="/">
                                            <p className="filter-subheading">Application Type:</p>
                                            <input type="radio" id="financial" name="fav_language" value="Financial" />
                                            <label for="financial">Financial</label><br />
                                            <input type="radio" id="non-financial" name="fav_language" value="Non-financial" />
                                            <label for="non-financial">Non-Financial</label>

                                            <p className="filter-subheading">Application Status:</p>
                                            <input type="radio" id="age1" name="age" value="30" />
                                            <label for="age1">Requested</label><br />
                                            <input type="radio" id="age2" name="age" value="60" />
                                            <label for="age2">Verified</label><br />
                                            <input type="radio" id="age3" name="age" value="100" />
                                            <label for="age3">Documents received</label><br />
                                            <input type="radio" id="age2" name="age" value="60" />
