...
export default function Request() {
  $(document).ready(function(){
    ...
    return(
        ...
        <form action="/action_page.php">
          <p>What kind of help do you want us to provide?</p>
  ...
  <textarea id="w3review" name="w3review" rows="4" cols="50" placeholder="Describe your request here..."></textarea>
        </form>
                      </div>
...
<div className="file-upload"> <p>Click on the "Choose File" button to upload your marksheet:</p>
        <form action="/action_page.php">
          <input type="file" id="myFile" name="filename" required/>
          <input type="submit" />
        </form></div>
                     
        <div className="file-upload"> <p>Click on the "Choose File" button to upload your attendence record:</p>
        <form action="/action_page.php">
          <input type="file" id="myFile" name="filename" required/>
          <input type="submit" />
        </form></div>
        <div className="file-upload"> <p>Click on the "Choose File" button to upload medical report:</p>
        <form action="/action_page.php">
          <input type="file" id="myFile" name="filename" required />
          <input type="submit" />
        </form></div>
